...
- [Connection Setup](#connection-setup)
  ...
  - [4. Connection Setup](#4-connection-setup)
    ...
    - [4.5 Link Allocation Negotiation](#45-link-allocation-negotiation)
  ...
  - [6. Message Contents and Elements](#6-message-contents-and-elements)
    ...
    - [6.5 RuleSet](#65-ruleset)
    - [6.6 Link Allocation Update (LAU)](#66-link-allocation-update-lau)
    - [5.7 Barrier](#57-barrier)
  - [Reference](#reference)
...
```
The following diagram more focus on how LAU works.
```mermaid
sequenceDiagram
    autonumber
...
### 4.5 Link Allocation Negotiation
...
### 6.6 Link Allocation Update (LAU)
