...
- [Connection Setup](#connection-setup)
  ...
  - [4. Connection Setup](#4-connection-setup)
    - [Connection Setup Phases](#connection-setup-phases)
    - [Connection Setup in single network](#connection-setup-in-single-network)
    - [Connection Setup over multiple networks](#connection-setup-over-multiple-networks)
...
### Connection Setup in single network
...
### Connection Setup over multiple networks
> RuleSet rewriting
...
`Connection Setup Request` *MUST*, *SHOULD* or *MAY* include the following information.
